...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'RecurringContract', fields ['shopper_reference', 'recurring_detail_reference']
        db.create_unique(u'adyen_recurringcontract', ['shopper_reference', 'recurring_detail_reference'])

        # Adding unique constraint on 'Notification', fields ['success', 'live', 'event_code', 'merchant_account_code', 'psp_reference']
        db.create_unique(u'adyen_notification', ['success', 'live', 'event_code', 'merchant_account_code', 'psp_reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'Notification', fields ['success', 'live', 'event_code', 'merchant_account_code', 'psp_reference']
        db.delete_unique(u'adyen_notification', ['success', 'live', 'event_code', 'merchant_account_code', 'psp_reference'])

        # Removing unique constraint on 'RecurringContract', fields ['shopper_reference', 'recurring_detail_reference']
        db.delete_unique(u'adyen_recurringcontract', ['shopper_reference', 'recurring_detail_reference'])
